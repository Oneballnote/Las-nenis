...
boton_balance = tkinter.Button(main_window, text = ' Balance ',border = 0,bg = '#89AAE6').grid(row = 5,column = 2)
boton_historial = tkinter.Button(main_window, text = 'Historial',border = 0,bg = '#89AAE6').grid(row = 6,column = 2)
boton_datos = tkinter.Button(main_window, text = '  Datos  ',border = 0,bg = '#89AAE6').grid(row = 7,column = 2)
